...
function runBaseTests() {
  px_login_1 = document.getElementById('px_login_1');

  suite('Base Automation Tests for px-login', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-login fixture is created', function() {
      assert.isTrue(document.getElementById('px_login_1') !== null);
    });
